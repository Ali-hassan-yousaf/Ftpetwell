...
//           setFormData({
//             name: userName || "",
//             email: 'hassan.shaihd@gmail.com',
//             sendemail: "",
//             company: "",
//             message: "Appointmnet Book Successfully",
//           });
//         },
//         (error) => {
//         }
...
//   const handleClick = () => {
//     bookAppointment();
//     console.log("worker name ", docId.email);
    ...
    try {
      ...
      if (data.success) {
        ...
        const formData = {
          ...
          email: "hassan.shaihd@gmail.com", // Sender or fallback email
        ...
        console.log("Sending email with data:", formData); // Debug formData

        await emailjs.send(serviceID, templateID, formData, publicKey);
        toast.success("Shedule successfully!");
